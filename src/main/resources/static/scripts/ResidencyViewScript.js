...
if(document.getElementById("bytext").checked == true){
	...
	document.getElementById("biopassport").disabled = false;
	...
	document.getElementById("biopassport").disabled = true;
...
if(document.getElementById("byvisafrom").checked == true){
	document.getElementById("visaMethodFromEqual").disabled = false;
	document.getElementById("visaMethodFromRange").disabled = false;
	document.getElementById("visaValidFromFrom").disabled = false;
	document.getElementById("visaValidFromTo").disabled = false;
	
	if(document.getElementById("visaMethodFromEqual").checked == true){
		document.getElementById("visaValidFromTo").disabled = true;
	}
}else{
	document.getElementById("visaMethodFromEqual").disabled = true;
	document.getElementById("visaMethodFromRange").disabled = true;
	document.getElementById("visaValidFromFrom").disabled = true;
	document.getElementById("visaValidFromTo").disabled = true;
}


if(document.getElementById("visaMethodFromEqual").checked == true){
	document.getElementById("labelvisaValidFromFromequal").hidden = false
	document.getElementById("labelvisaValidFromFrom").hidden = true
}else{
	document.getElementById("labelvisaValidFromFromequal").hidden = true
	document.getElementById("labelvisaValidFromFrom").hidden = false
}


document.getElementById("byvisafrom").onchange = function(){
	if(document.getElementById("byvisafrom").checked == true){
		document.getElementById("visaMethodFromEqual").disabled = false;
		document.getElementById("visaMethodFromRange").disabled = false;
		document.getElementById("visaValidFromFrom").disabled = false;
...
document.getElementById("visaMethodFromEqual").onchange = function(){
	document.getElementById("visaValidFromTo").disabled = true;
	document.getElementById("labelvisaValidFromFromequal").hidden = false
	document.getElementById("labelvisaValidFromFrom").hidden = true
}

document.getElementById("visaMethodFromRange").onchange = function(){
	document.getElementById("visaValidFromTo").disabled = false;
	document.getElementById("labelvisaValidFromFromequal").hidden = true
	document.getElementById("labelvisaValidFromFrom").hidden = false
}
...
if(document.getElementById("byvisato").checked == true){
	document.getElementById("visaMethodToEqual").disabled = false;
	document.getElementById("visaMethodToRange").disabled = false;
	document.getElementById("visaValidToFrom").disabled = false;
	document.getElementById("visaValidToTo").disabled = false;
	
	if(document.getElementById("visaMethodToEqual").checked == true){
		document.getElementById("visaValidToTo").disabled = true;
	}
}else{
	document.getElementById("visaMethodToEqual").disabled = true;
	document.getElementById("visaMethodToRange").disabled = true;
	document.getElementById("visaValidToFrom").disabled = true;
	document.getElementById("visaValidToTo").disabled = true;
}


if(document.getElementById("visaMethodToEqual").checked == true){
	document.getElementById("labelvisaValidToFromequal").hidden = false
	document.getElementById("labelvisaValidToFrom").hidden = true
}else{
	document.getElementById("labelvisaValidToFromequal").hidden = true
	document.getElementById("labelvisaValidToFrom").hidden = false
}


document.getElementById("byvisato").onchange = function(){
	if(document.getElementById("byvisato").checked == true){
		document.getElementById("visaMethodToEqual").disabled = false;
		document.getElementById("visaMethodToRange").disabled = false;
		document.getElementById("visaValidToFrom").disabled = false;
...
document.getElementById("visaMethodToEqual").onchange = function(){
	document.getElementById("visaValidToTo").disabled = true;
	document.getElementById("labelvisaValidToFromequal").hidden = false
	document.getElementById("labelvisaValidToFrom").hidden = true
}

document.getElementById("visaMethodToRange").onchange = function(){
	document.getElementById("visaValidToTo").disabled = false;
	document.getElementById("labelvisaValidToFromequal").hidden = true
	document.getElementById("labelvisaValidToFrom").hidden = false
}
