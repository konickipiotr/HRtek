...
//		fontstyle(r3, true);
//		r3.setText("UWC sp. z o.o., ul. Kutnowska 1-3, 53-135 Wrocław NIP 8992828461, KRAZ 17873 ");
//		r3.addBreak();
//		r3 = p3.createRun();
//		fontstyle(r3, false);
//		r3.setText("далее ");
...
//		r3 = p3.createRun();
//		fontstyle(r3, true);
//		r3.setText(wbd.getFirstname() + " " + wbd.getLastname());
//		r3 = p3.createRun();
//		fontstyle(r3, false);
//		r3.setText(" номер и серия удосоверения личности/паспорта ");
//		r3 = p3.createRun();
//		fontstyle(r3, true);
//		r3.setText(wd.getPassport().isBlank() ? wd.getBiopassport() : wd.getPassport());
//		r3 = p3.createRun();
//		fontstyle(r3, false);
//		r3.setText(" почтовый адрес или адрес прописки ");
//		r3 = p3.createRun();
//		fontstyle(r3, true);
//		r3.setText(contact.getStreet() + ", " + contact.getPostcode() + " " + contact.getCity());
//		r3 = p3.createRun();
//		fontstyle(r3, false);
//		r3.setText(" далее ");
...
//		r8 = p8.createRun();
//		fontstyle(r8, true);
//		r8.setText(String.valueOf(wbd.getPayment()));
//		r8 = p8.createRun();
//		fontstyle(r8, false);
//		r8.setText(" злотых брутто в час (семнадцать злотых тридцать четыре гроши брутто в час).");
//		
//		r8.addBreak();
//		r8 = p8.createRun();
//		fontstyle(r8, false);
...
//	
	void pl() {
		...
		r3 = p3.createRun();
		fontstyle(r3, false);
		r3.setText("A Panem/ Panią ");
		r3 = p3.createRun();
		fontstyle(r3, true);
		r3.setText(worker.getFirstname() + " " + worker.getLastname());
		r3 = p3.createRun();
		fontstyle(r3, false);
		r3.setText(" legitymującym/cą się dowodem osobistym/paszportem seria i nr ");
		r3 = p3.createRun();
		fontstyle(r3, true);
		r3.setText(residency.getPassport().isBlank() ? residency.getBiopassport() : residency.getPassport());
		r3 = p3.createRun();
		fontstyle(r3, false);
		r3.setText(" adres korespondencyjny w Pana/Pani kraju ");
		r3 = p3.createRun();
		fontstyle(r3, true);
		r3.setText(contact.getAddress() + ", " + contact.getPostcode() + " " + contact.getCity());
		r3 = p3.createRun();
		fontstyle(r3, false);
		r3.setText(" zwanym/ną dalej ");
		XWPFRun r4_h = p4.createRun();
		fontstyle(r4_h, true);
		r3 = p3.createRun();
		fontstyle(r3, true);
		...
		r8 = p8.createRun();
		fontstyle(r8, true);
		r8.setText(String.valueOf(factory.getHourlyrate()));
		r8 = p8.createRun();
		fontstyle(r8, false);
		r8.setText(" zł  brutto/godzina, (słownie: siedemnaście złotych trzydzieści cztery groszy 74/100 brutto za godzinę");
		r8.addBreak();
		r8 = p8.createRun();
		fontstyle(r8, false);
...
//		r14 = p14.createRun();
//		fontstyle(r14, true);
//		r14.setText(wbd.getAgreementTo() != null ? wbd.getAgreementTo().toString() : ".......................................-......................................");
//		r14.addBreak();
//		r14 = p14.createRun();
//		fontstyle(r14, false);
...
//		r16 = p16.createRun();
//		fontstyle(r16, false);
//		r16.setText("2. Zleceniobiorca ma prawo wypowiedziec umowę zlecenia z zachowaniem terminu 7 dni roboczych.");
//		r16.addBreak();
//		
//		XWPFParagraph p17 = doc.createParagraph();
//		p17.setAlignment(ParagraphAlignment.CENTER);
...
//		XWPFRun r20 = p20.createRun();
//		fontstyle(r20, false);
//		r20.setText("1.Umowa została sporządzona w dwóch jednobrzmiących egzemplarzach w dwóch jezykach – po jednej  dla każdej ze stron.");
//		r20.addBreak();
//		r20 = p20.createRun();
//		fontstyle(r20, false);
...
//	public Contract(WorkerBasicData wbd, Workdata wd, Contact contact, Company factory) {
//		this.wbd = wbd;
//		this.wd = wd;
...
//		this.doc = doc;
//	}
//	public WorkerBasicData getWbd() {
//		return wbd;
//	}
//	public void setWbd(WorkerBasicData wbd) {
//		this.wbd = wbd;
//	}
