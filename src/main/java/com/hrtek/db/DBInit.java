...
public class DBInit implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		this.candidateRepo.save(new Candidate("Jola", "Fasola", "F", "jola.fasola@mail.com", "775418125", u4.getId(), "Może zacząć dopiero do grudnia"));
		this.candidateRepo.save(new Candidate("Hubert", "Malinowski", "M", "hubert.malinowski@mail.com", "951753456", u5.getId(), "Podejrzany typ"));
		...
		wd1.setStartZus(LocalDate.of(2020, 01, 20));
		...
		wd3.setStartZus(LocalDate.of(2020, 05, 20));
